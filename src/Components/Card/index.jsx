...
export default function Card() {
  ...
  console.log("hello there! ", `\n`, "since you are here check phone view");
              ...
              <VStack align="left" ml="4">
                ...
                <Stack display={{ md: 'none' }} direction={{ base: 'column', md: 'column' }} w={{ base: '11rem' }}>
                  <Stack direction="column" spacing={2} justifyContent="space-between">
                    ...
                    <Button colorScheme="green" onClick={() => { onOpenReportModal(); setCurrentModal(Doctor.name) }}>Book an Appointment</Button>
                  </Stack>
                </Stack>
              </VStack>
              <Center>
                ...
                <SimpleGrid
                  ...
                  <Stack spacing={{ base: 6, md: 10 }}>
                    ...
                    <Stack
                      ...
                      <SimpleGrid maxW={"sm"} display= 'flex' columns={{ base: 5, md: 3, }} spacing={{ base: 5, lg: 8 }} justifyContent="center">
                        <Divider orientation='vertical' />
